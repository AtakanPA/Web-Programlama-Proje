...
<body class="h-100  d-flex flex-column">
		...
		<div class="container-fluid logo">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item">
						<a href="ozgecmis.php" class="nav-link active" aria-current="page">ÖzGeçmişim</a>
					</li>
	...
	<header>
		<div class="container">
			<h1 class="h1 text-center mycolor mt-5">ÖZGEÇMİŞİM</h1>
         	<div class="row">
         			<div class="border border-dark  bckcolor mt-5 text-white col-lg-4 p-5">
         					<h5 class="text-center ">Eğitim Geçmişim</h5>
         					<p class="text-center fs-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
         			...
         			<div class="border border-dark  bckcolor mt-5 text-white col-lg-4 p-5">
         				<h5 class="text-center">Şuanki Durumum</h5>
         				<p class="text-center fs-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
         				tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
         				quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
         				consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
         			...
         			<div class="border  border-dark bckcolor mt-5 text-white col-lg-4 p-5">
         				<h5 class="text-center">İleriki Hedeflerim</h5>
         				<p class="text-center fs-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
         				tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
         				quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
         				consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
